...
function SelectNode:initTypeSelect()
  ...
  for i=1, self._mobilePutCard.cbMobilePutCount do
    ...
    if middletype == GameLogic.CT_FIVE_MIXED_FLUSH_NO_A then
      middletype = GameLogic.CT_FIVE_MIXED_FLUSH_FIRST_A
    elseif middletype == GameLogic.CT_FIVE_STRAIGHT_FLUSH then
      middletype = GameLogic.CT_FIVE_STRAIGHT_FLUSH_FIRST_A
    end

    if tailtype == GameLogic.CT_FIVE_MIXED_FLUSH_NO_A then
      tailtype = GameLogic.CT_FIVE_MIXED_FLUSH_FIRST_A
    elseif tailtype == GameLogic.CT_FIVE_STRAIGHT_FLUSH then
      tailtype = GameLogic.CT_FIVE_STRAIGHT_FLUSH_FIRST_A
    end
