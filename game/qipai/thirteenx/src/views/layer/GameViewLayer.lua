...
function GameViewLayer:ctor(scene)
  ...
  self._bSound = (GlobalUserItem.nSound == 100)
  self._bMusic = (GlobalUserItem.nMusic == 100)
    ...
    for i=beginpos,beginpos+length do
      ...
      if nil ~= pcard then
        ...
        if i == midpos then
          ...
          if cardType == GameLogic.CT_FIVE_MIXED_FLUSH_NO_A then
            cardType = GameLogic.CT_FIVE_MIXED_FLUSH_FIRST_A
          elseif cardType == GameLogic.CT_FIVE_STRAIGHT_FLUSH then
            cardType = GameLogic.CT_FIVE_STRAIGHT_FLUSH_FIRST_A
          end
