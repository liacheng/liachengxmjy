...
cmd.WINRRCORD_LENGTH			= 76					    --每条记录字长
...
--时间标识
cmd.TIME_USER_START_GAME		= 15									--开始定时器
cmd.TIME_USER_OPEN_CARD			= 15									--摊牌定时器
cmd.TIME_USER_AUTO_GAME         = 3                                     --自动游戏定时器
