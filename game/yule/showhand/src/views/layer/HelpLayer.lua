...
HelpLayer.RES_PATH 				= "game/yule/showhand/res/"
...
function HelpLayer:ctor(scene, nKindId, nType)
    ...
    --加载csb资源
    self.csbNode = ExternalFun.loadCSB(HelpLayer.RES_PATH.."set/HelpLayer.csb", self)
    ...
    local csbBg = self.csbNode:getChildByName("m_pNodeHelp")
