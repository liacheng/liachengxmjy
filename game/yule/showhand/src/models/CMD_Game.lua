...
cmd.CMD_S_StatusPlay   =
{
    ...
    {k="cbHandCardData",t="byte",l={cmd.RECORD_LEN,cmd.RECORD_LEN}}, --桌面扑克
    --历史积分
    {k="lTurnScore",t="score",l={cmd.GAME_PLAYER}},      --积分信息 
    {k="lCollectScore",t="score",l={cmd.GAME_PLAYER}},   --积分信息
    --机器人信息
...
cmd.CMD_S_GAMEStart =
{
    ...
    {k="cbHandCardData",t="byte",l={cmd.RECORD_LEN,cmd.RECORD_LEN}} --用户扑克
}
...
cmd.CMD_S_SendScore  =
{
    ...
    {k="cbCardData",t="byte",l={2,2}}                   --发牌数目--奇葩的定义
}
...
cmd.RES_PATH 					= 	"game/yule/showhand/res/"
print("********************************************************load cmd");
return cmd