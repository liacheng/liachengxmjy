...
function PriGameLayer:ctor( gameLayer )
    ...
    local frame = cc.Director:getInstance():getTextureCache():addImage(yl.PNG_PUBLIC_BLANK)
    self.m_spBankerMode:setTexture(frame)
    self.m_szModeName = ""
...
function PriGameLayer:onExit()
    cc.SpriteFrameCache:getInstance():removeSpriteFramesFromFile("game/27_pri_game.plist")
    cc.Director:getInstance():getTextureCache():removeTextureForKey("game/27_pri_game.png")
end
