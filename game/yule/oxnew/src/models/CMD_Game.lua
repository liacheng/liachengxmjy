...
cmd.CMD_S_StatusFree = 
{
    ...
    { k = "banker_config",t = "int"},                                   --庄家配置
    { k = "bRoomCardScore",t = "bool"},                                 --房卡积分模式
    { k = "lRoomCardJetton",t = "score", l={4}},                        --积分房卡配置的下注
}
...
cmd.CMD_S_StatusScore = 
{
    ...
    { k = "cbDynamicJoin",t = "byte"},                                      --动态加入
    { k = "cbTimeLeave",t = "byte"},                                        --剩余时间
    { k = "lTurnMaxScore",t = "score",l = {cmd.GAME_PLAYER}},               --最大下注
...
cmd.CMD_S_StatusPlay = 
{
    ...
    --扑克信息
    --桌面扑克
    { k = "cbHandCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
...
--*******************        时间标识         *****************--
--叫庄定时器
cmd.TIME_USER_CALL_BANKER		= 15
--开始定时器
cmd.TIME_USER_START_GAME		= 15
--加注定时器
cmd.TIME_USER_ADD_SCORE			= 15
--摊牌定时器
cmd.TIME_USER_OPEN_CARD			= 15
