...
function GameSetLayer:ctor(version)
    ...
    -- 音乐按钮-关
    -- 音乐文字
	ccui.Button:create("oxnew_set_btn_open.png","oxnew_set_btn_open.png","oxnew_set_btn_open.png",UI_TEX_TYPE_PLIST)
        :move(567, 340)
        :setTag(GameSetLayer.TAG_MUSIC_OPEN)
        :addTo(self)
        :addTouchEventListener(onBtnCallBack)

	ccui.Button:create("oxnew_set_btn_close.png","oxnew_set_btn_close.png","oxnew_set_btn_close.png",UI_TEX_TYPE_PLIST)
        :move(567, 340)
    ...
    -- 关闭按钮
    ccui.Button:create("oxnew_btn_close_1.png","oxnew_btn_close_1.png","oxnew_btn_close_1.png",UI_TEX_TYPE_PLIST)
        :move(935, 490)
