...
--音效
cmd.Bgm                 = "fishzyqs4_bgm.mp3"
cmd.ChangeScene         = "fishzyqs4_change_scene.mp3"
cmd.CoinAnimation       = "fishzyqs4_coin_animation.wav"
cmd.Coinfly             = "fishzyqs4_coinfly.wav"
cmd.FishSpecial         = "fishzyqs4_special.wav"
cmd.Combo               = "fishzyqs4_combo.wav"
cmd.Shell_8             = "fishzyqs4_shell_8.mp3"
cmd.SmallBegin          = "fishzyqs4_small_begin.wav"
cmd.BigCoin             = "fishzyqs4_coin.mp3"
cmd.BtnSound            = "fishzyqs4_click.mp3"
cmd.CatchBigFishSound   = "fishzyqs4_catch_bigfish.mp3"
cmd.BigFishComing       = "fishzyqs4_bigfish_coming.mp3"
cmd.FallNetSound        = "fishzyqs4_fall_net.mp3"
...
cmd.CMD_S_GameConfig = 
{
    ...
    { k = "firetime",                   t = "int", l = {2}                  },
    { k = "pousefiretime",              t = "int", l = {2}                  },
    { k = "firecount",                  t = "int", l = {2}                  },
    { k = "changefirecount",            t = "int", l = {2}                  },
    { k = "anglechangecount",           t = "int", l = {2}                  }
...
cmd.CMD_S_Fire = 
{
    ...
    { k = "is_android_scene", t= "bool" }           -- 机器人场景问题
...
cmd.SUB_C_USER_LOCKFISH             =       3500            -- 发送锁鱼
