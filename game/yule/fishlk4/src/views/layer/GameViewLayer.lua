...
GameViewLayer.RES_PATH = device.writablePath.. "game/yule/fishlk4/res/"
...
--底部框隐藏
--    local bgScore = display.newSprite("#lkpy_bg_lowarticle.png")
...
--    self:addChild(autoLockBG,20)
    ...
    self.autoShootBtn = ccui.Button:create("lkpy_btn_auto.png","lkpy_btn_auto.png","lkpy_btn_auto.png",UI_TEX_TYPE_PLIST)      -- 自动射击
...
--    self.autoShootBtn:setScaleY(0.9)
    ...
    self.autoLockBtn = ccui.Button:create("lkpy_btn_lock.png","lkpy_btn_lock.png","lkpy_btn_lock.png",UI_TEX_TYPE_PLIST)       -- 自动锁定
...
--    autoLockBtn:setScaleY(0.9)
    ...
    self:addChild(self.autoLockBtn,22)
        ---fix  没有图只能用一用
    self.speedUpBtn = ccui.Button:create("lkpy_btn_speed1.png","lkpy_btn_speed1.png","lkpy_btn_speed1.png",UI_TEX_TYPE_PLIST)       -- 加速
...
--    self.speedUpBtn:addChild(label3,3)
    ...
    --添加按钮背景
--    self.menuSetBtnBg = display.newSprite("#lkpy_btntable_down.png")
--    self.menuSetBtnBg:setAnchorPoint(0.5,1)
--    self.menuSetBtnBg:setPosition(58, yl.HEIGHT -11)
--    self:addChild(self.menuSetBtnBg,21)

--    self.menuSetBtnBg2 = display.newSprite("#lkpy_btntable_down.png")
...
--    self.menuSetBg = ccui.ImageView:create("lkpy_bg_down.png",UI_TEX_TYPE_PLIST)      -- 添加菜单背景
...
--    self.menuSetBg:addChild(bank)
    ...
    --按钮收缩菜单按钮
--    self.shrinkmenu = ccui.Button:create("lkpy_btn_down.png","lkpy_btn_down.png","lkpy_btn_down.png",UI_TEX_TYPE_PLIST)
...
--    self:addChild(self.shrinkmenu,23)
    ...
    --按钮收缩菜单箭头
--    self.shrinkmenuarrows = display.newSprite("#lkpy_btn_downarrow.png")
...
--    self.shrinkmenu:addChild(self.shrinkmenuarrows)
    ...
    self.menu = ccui.Button:create("lkpy_btn_down.png","lkpy_btn_down.png","lkpy_btn_down.png",UI_TEX_TYPE_PLIST)               -- 菜单
    ...
    --菜单箭头
    self.menuarrows = display.newSprite("#lkpy_btn_downarrow.png")
    self.menuarrows:setAnchorPoint(0.5,0.5)
    self.menuarrows:setPosition(50,48)
    self.menu:addChild(self.menuarrows)

    self.help = ccui.Button:create("lkpy_btn_help.png","lkpy_btn_help.png","lkpy_btn_help.png",UI_TEX_TYPE_PLIST)
    self.help:setTag(2)
    ...
    self.set = ccui.Button:create("lkpy_btn_set.png","lkpy_btn_set.png","lkpy_btn_set.png",UI_TEX_TYPE_PLIST)
    self.set:setTag(3)
    ...
    self.clear = ccui.Button:create("lkpy_btn_turnback.png","lkpy_btn_turnback.png","lkpy_btn_turnback.png",UI_TEX_TYPE_PLIST)
    self.clear:setTag(4)
...
--    self:addChild(nick,22)
    ...
    --用户分数 
--    local score = cc.Label:createWithCharMap("game_res/lkpy_num_small.png",18,25,string.byte("%"))
--用户的分数隐藏
...
--    local score = cc.LabelAtlas:create(num,"game_res/lkpy_num_small.png",18,25, string.byte("*"))
...
function GameViewLayer:setAutoShoot(b,target)
    if b then
        ...
        target:loadTextureNormal("lkpy_btn_autoing.png",UI_TEX_TYPE_PLIST);
        target:loadTexturePressed("lkpy_btn_autoing.png",UI_TEX_TYPE_PLIST);
    else
        self.tempNode:setVisible(false)
        target:loadTextureNormal("lkpy_btn_auto.png",UI_TEX_TYPE_PLIST);
        target:loadTexturePressed("lkpy_btn_auto.png",UI_TEX_TYPE_PLIST);
    end
end
...
function GameViewLayer:setAutoLock(b,target)
    if b then
        ...
        target:loadTextureNormal("lkpy_btn_locking.png",UI_TEX_TYPE_PLIST);
        target:loadTexturePressed("lkpy_btn_locking.png",UI_TEX_TYPE_PLIST);
    else
        self.tempLockNode:setVisible(false)
        target:loadTextureNormal("lkpy_btn_lock.png",UI_TEX_TYPE_PLIST);
        target:loadTexturePressed("lkpy_btn_lock.png",UI_TEX_TYPE_PLIST);
        --取消自动射击
...
function GameViewLayer:setSpeedUP(mutiple,target)
    ...
    local TextureName = string.format("lkpy_btn_speed%d.png",mutiple)
...
--        local light = csbNode:getChildByName("Sprite_light")
    ...
    elseif 3 == tag then --设置
        ...
        local btnShake = csbNode:getChildByName("btn_shake")          -- 音效按钮
        ...
        if GlobalUserItem.nMusic == 100 then
            muteBtnVoice:loadTextureNormal("lkpy_btn_setopen.png",UI_TEX_TYPE_PLIST)
        end

        if GlobalUserItem.nSound == 100 then
            muteBtn:loadTextureNormal("lkpy_btn_setopen.png",UI_TEX_TYPE_PLIST)   
        end

        if GlobalUserItem.bShake == 1 then
            btnShake:loadTextureNormal("lkpy_btn_setopen.png", UI_TEX_TYPE_PLIST) 
        end
        ...
        muteBtn:addTouchEventListener(function( sender,eventType ) -- 音效按钮
            if eventType == ccui.TouchEventType.ended then
                ...
                if GlobalUserItem.nSound == 100 then
                    ...
                    muteBtn:loadTextureNormal("lkpy_btn_setclose.png",UI_TEX_TYPE_PLIST)
                end
            end
        end)
        ...
        muteBtnVoice:addTouchEventListener(function( sender,eventType ) -- 音乐按钮
            if eventType == ccui.TouchEventType.ended then
                ...
                if GlobalUserItem.nMusic == 100 then
                    ...
                    muteBtnVoice:loadTextureNormal("lkpy_btn_setclose.png",UI_TEX_TYPE_PLIST)
                end
            end
        end)
        ...
        btnShake:addTouchEventListener(function(sender,eventType)       -- 震屏按钮
            if eventType == ccui.TouchEventType.ended then
                ...
                if GlobalUserItem.bShake == 1 then
                    ...
                    btnShake:loadTextureNormal("lkpy_btn_setclose.png",UI_TEX_TYPE_PLIST)
                end
            end
        end)
...
function GameViewLayer:ShowCoin( score,wChairID,pos,fishtype )
    ...
    if fishtype < 5 then
        ...
        frameName = "lkpy_silver_coin_0.png"
    ...
    elseif fishtype>=5 and fishtype<17 then
        ...
        frameName = "lkpy_gold_coin_1.png"
    ...
    if nil ~= anim then
        ...
        local num = cc.LabelAtlas:create(string.format("%d", score),"game_res/lkpy_num_small.png",18,25, string.byte("*"))
...
function GameViewLayer:ShowCoin2(score, wChairID, fish_pos, fishRotation)
    ...
    local goldNum = cc.LabelAtlas:create(num,"game_res/lkpy_num_bigfish.png",54,75,string.byte("/"))
...
function GameViewLayer:RandomCoin(fishPos, coinNum,  cannon, score)
    ...
    for i = 1, coinNum do
        ...
        fishSpr = display.newSprite("#lkpy_gold_coin_7.png")
        :addTo(self._scene.m_cannonLayer, 1)
