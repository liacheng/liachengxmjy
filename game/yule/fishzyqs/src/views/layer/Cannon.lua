...
function Cannon:initWithUser(userItem)
	...
	self.m_fort = display.newSprite("#zyqs_gun_1_1.png")
    ...
    --底座
	self.m_gunPlatformButtom = display.newSprite("#zyqs_gunPlatformButtom1_1.png")
    ...
    self.m_labelMutiple = cc.LabelAtlas:create("1","game_res/zyqs_num_small.png",18,25,string.byte("*")) --倍数
...
function Cannon:setMultiple(multiple,chairId)
    ...
    if self.m_SpecialCannon == true then
        frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_1_2.png")
        gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom2_1.png")
        if multiple >= 100 and multiple < 1000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_2_2.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom2_2.png")
        elseif multiple >= 1000 and multiple < 5000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_3_2.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom2_3.png")
        elseif multiple >= 5000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_4_2.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom2_4.png")
        end
    elseif self.m_SpecialCannon == false then 
        frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_1_1.png")
        gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_1.png")
        if multiple >= 100 and multiple < 1000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_2_1.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_2.png")
        elseif multiple >= 1000 and multiple < 5000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_3_1.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_3.png")
        elseif multiple >= 5000 then
            frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_4_1.png")
            gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_4.png")
        end
    end
...
function Cannon:setMyMultiple(multiple)
    ...
    local mutipleStr = string.format("%d", multiple)
    self.m_labelMutiple:setString(mutipleStr)
    local frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_1_1.png")
    local gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_1.png")
    if multiple >= 100 and multiple < 1000 then
        frame = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_2_1.png")
        gunPlatform = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_2.png")
    elseif multiple >= 1000 and multiple < 5000 then
...
function Cannon:setLockFishLogo(chairId,fishKind)
    local frameName = string.format("zyqs_lock_flag_%d.png", fishKind+1)
    local frame = cc.SpriteFrameCache:getInstance():getSpriteFrame(frameName)

    local switchfish = cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_switch_fish.png")
    ...
    if nil ~= frame then
        ...
        if nil == sp then
            ...
            sp1:setName("zyqs_switch_fish.png")
            sp1:setPosition(pos1.x,pos1.y)
            self:addChild(sp1)
            sp1:runAction(cc.RepeatForever:create(CirCleBy:create(1.0,cc.p(pos1.x,pos1.y),10)))

            local btnswitchfish1 = ccui.Button:create("zyqs_switch_fish.png","zyqs_switch_fish.png","zyqs_switch_fish.png",UI_TEX_TYPE_PLIST)
...
function Cannon:productBullet( isSelf,fishIndex, netColor,bundleChairId,bullet_mulriple,bulletId,android_chairid,bulletSpeedIndex)  -- 制造子弹
    ...
    local gun_spark = display.newSprite("#zyqs_iocn_fire.png")
...
--        return
		self.m_fort:setSpriteFrame(cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_1_1.png"))
        self.m_gunPlatformButtom:setSpriteFrame(cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_1.png"))
	...
	elseif cannontype == g_var(cmd).CannonType.Normal_Cannon then
		self.m_Type = g_var(cmd).CannonType.Normal_Cannon
		self.m_fort:setSpriteFrame(cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gun_1_1.png"))
        self.m_gunPlatformButtom:setSpriteFrame(cc.SpriteFrameCache:getInstance():getSpriteFrame("zyqs_gunPlatformButtom1_1.png.png"))
		self:removeTypeTag()
	end
end
