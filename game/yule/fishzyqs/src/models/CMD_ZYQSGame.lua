...
--音效
cmd.Bgm                 = "sound_res/fishzyqs_bgm.mp3"
cmd.ChangeScene         = "fishzyqs_change_scene.mp3"
cmd.CoinAnimation       = "fishzyqs_coin_animation.wav"
cmd.Coinfly             = "fishzyqs_coinfly.wav"
cmd.FishSpecial         = "fishzyqs_special.wav"
cmd.Combo               = "fishzyqs_combo.wav"
cmd.Shell_8             = "fishzyqs_shell_8.mp3"
cmd.SmallBegin          = "fishzyqs_small_begin.wav"
cmd.BigCoin             = "fishzyqs_coin.mp3"
cmd.BtnSound            = "fishzyqs_click.mp3"
cmd.CatchBigFishSound   = "fishzyqs_catch_bigfish.mp3"
cmd.BigFishComing       = "fishzyqs_bigfish_coming.mp3"
cmd.FallNetSound        = "fishzyqs_fall_net.mp3"
...
cmd.CMD_S_Fire = 
{
    ...
    { k = "is_android_scene", t= "bool" }           -- 机器人场景掉分问题
