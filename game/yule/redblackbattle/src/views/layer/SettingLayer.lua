...
function SettingLayer:ctor(version)
    ...
    -- 音乐按钮-关
    -- 音乐文字
	ccui.Button:create("redblackbattle_set_open.png","redblackbattle_set_open.png","redblackbattle_set_open.png",UI_TEX_TYPE_PLIST)
        :move(594, 375)
        :setTag(SettingLayer.TAG_MUSIC_OPEN)
        :addTo(self)
        :addTouchEventListener(onBtnCallBack)

	ccui.Button:create("redblackbattle_set_close.png","redblackbattle_set_close.png","redblackbattle_set_close.png",UI_TEX_TYPE_PLIST)
        :move(594, 375)
    ...
    -- 关闭按钮
    ccui.Button:create("redblackbattle_btn_close.png","redblackbattle_btn_close.png","redblackbattle_btn_close.png",UI_TEX_TYPE_PLIST)
        :move(880, 512)
    ...
    ccui.Text:create(verstr, "fonts/round_body.ttf", 25)
		:setTextColor(cc.c4b(94,58,29,255))
