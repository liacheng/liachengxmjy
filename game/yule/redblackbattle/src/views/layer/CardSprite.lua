...
--------
function CardSprite:ctor(path)
--	-- body
end
--创建卡牌
function CardSprite:createCard( cbCardData )
	local sp = CardSprite:create()
    local sp1 = display.newSprite("cards_s.png")
    local tex = sp1:getTexture()
	--sp.m_strCardFile = "cards_s.png"
...
function CardSprite:createBack(  )
    ...
    --local m_spBack = cc.Sprite:create("redblackbattle_icon_cardBack.png")
