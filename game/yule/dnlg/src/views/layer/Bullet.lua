...
function Bullet:ctor(angle,chairId,mutiple,CannonType,cannon,android_chairId,bulletSpeedIndex)
...
function Bullet:getBulletNum()
    local mutipleNum = 1
    local mutiple = self.m_nMultiple /self.gameConfig_min_bullet_multiple

    if self.m_nMultiple >= 1000 then
        mutipleNum = 2
    end
...
function Bullet:setType(type)
    self.m_Type = type
    local pwarhead = cc.Sprite:create("game_res/im_bullet_yellow.png")
    local nBulletNum = self:getBulletNum()
    if nBulletNum == 3 then
        pwarhead = cc.Sprite:create("game_res/im_bullet_red.png")
    elseif nBulletNum == 2 then
        pwarhead = cc.Sprite:create("game_res/im_bullet.png")
    else
        pwarhead = cc.Sprite:create("game_res/im_bullet_yellow.png")
    end
    --local pwarhead = cc.Sprite:create("game_res/im_bullet.png")
