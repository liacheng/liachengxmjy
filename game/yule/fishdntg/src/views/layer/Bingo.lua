...
function Bingo:ctor(viewParent)
    ...
    self.bingoBG = display.newSprite("#Reward_Box_0.png")
        :addTo(self)
    self.bingoScore = cc.LabelAtlas:create(0,"game_res/dntg_num_small.png",18,25, string.byte("*"))
    ...
    {
    	cc.p(448 + xoffset, 600),
	    cc.p(896 + xoffset, 600),
	    cc.p(448 + xoffset, 245),
	    cc.p(896 + xoffset, 245)
	}
