...
function CannonLayer:init()
	...
	local tipsImage = ccui.ImageView:create("dntg_bg_tag.png",UI_TEX_TYPE_PLIST)        -- 位置提示
	tipsImage:setAnchorPoint(cc.p(0.5,0.0))
	tipsImage:setPosition(cc.p(myCannon:getPositionX(),260))
	self:addChild(tipsImage)

	local arrow = ccui.ImageView:create("dntg_bg_tagarrows.png",UI_TEX_TYPE_PLIST)
...
--	self:addChild(nick)
    --用户昵称隐藏
--	local score = cc.Label:createWithCharMap("game_res/dntg_num_small.png",18,25,string.byte("%"))    -- 用户分数
...
--	local gunPlatformButtom = display.newSprite("#dntg_gunPlatformButtom1_1.png")
