...
function Gold:showGold(curScore)
    ...
    if #self.m_goldList >= 3 then
        ...
        local gold = cc.Sprite:create("game_res/dntg_icon_golds.png", cc.rect(0, 0, 38, 7));
        ...
        local goldNum = cc.LabelAtlas:create(num,"game_res/dntg_num_small.png",18,25, string.byte("*"))
...
function Gold:showGoldEx(curScore , chairId)
    ...
    local coin = display.newSprite("#dntg_icon_coin.png")
