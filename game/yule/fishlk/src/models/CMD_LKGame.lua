...
--音效
cmd.Bgm                 = "sound_res/fishlk_bgm.mp3"
cmd.ChangeScene         = "fishlk_change_scene.mp3"
cmd.CoinAnimation       = "fishlk_coin_animation.wav"
cmd.Coinfly             = "fishlk_coinfly.wav"
cmd.FishSpecial         = "fishlk_special.wav"
cmd.Combo               = "fishlk_combo.wav"
cmd.Shell_8             = "fishlk_shell_8.mp3"
cmd.SmallBegin          = "fishlk_small_begin.wav"
cmd.BigCoin             = "fishlk_coin.mp3"
cmd.BtnSound            = "fishlk_click.mp3"
cmd.CatchBigFishSound   = "fishlk_catch_bigfish.mp3"
cmd.BigFishComing       = "fishlk_bigfish_coming.mp3"
cmd.FallNetSound        = "fishlk_fall_net.mp3"
