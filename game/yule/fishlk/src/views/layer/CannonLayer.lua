...
function CannonLayer:ctor(viewParent)
    ...
    {
    	cc.p(342 + xoffset,730),
	    cc.p(787 + xoffset,730),
	    cc.p(1227 + xoffset,730),
	    cc.p(105 + xoffset,115),
	    cc.p(545 + xoffset,115),
        cc.p(1005 + xoffset,115)
	}
	self.m_GunPlatformPos =         -- gun位置
	{
		cc.p(341 + xoffset,733),
		cc.p(787 + xoffset,733),
		cc.p(1227 + xoffset,733),
		cc.p(105 + xoffset,70),
		cc.p(545 + xoffset,70),
        cc.p(1005 + xoffset,70)
	}
...
function CannonLayer:init()
	...
	local tipsImage = ccui.ImageView:create("lkpy_bg_tag.png",UI_TEX_TYPE_PLIST)        -- 位置提示
	tipsImage:setAnchorPoint(cc.p(0.5,0.0))
	tipsImage:setPosition(cc.p(myCannon:getPositionX(),260))
	self:addChild(tipsImage)

	local arrow = ccui.ImageView:create("lkpy_bg_tagarrows.png",UI_TEX_TYPE_PLIST)
...
--	self:addChild(nick)
    --用户昵称隐藏
--	local score = cc.Label:createWithCharMap("game_res/lkpy_num_small.png",18,25,string.byte("%"))    -- 用户分数
	...
	score:setPosition(self.m_ScorePos.x+20, self.m_ScorePos.y)
...
--	local gunPlatformButtom = display.newSprite("#lkpy_gunPlatformButtom1_1.png")
