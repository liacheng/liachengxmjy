...
GameLogic.HJ_CT_SPECIAL_11 = 2						--二八=2-8
GameLogic.HJ_CT_SPECIAL_10 = 3						--Q8
GameLogic.HJ_CT_SPECIAL_9 = 4						--Q9
GameLogic.HJ_CT_SPECIAL_8 = 5						--对黑7，对黑8，对(红)9，对(红)5
GameLogic.HJ_CT_SPECIAL_7 = 6						--*对黑6，对红7，*对黑10，对(黑)J
GameLogic.HJ_CT_SPECIAL_6 = 7						--对黑4，*对红6，*对红10
GameLogic.HJ_CT_SPECIAL_5 = 8						--对合=对红4
GameLogic.HJ_CT_SPECIAL_4 = 9						--对人=对红8
GameLogic.HJ_CT_SPECIAL_3 = 10						--皇帝=黑桃A+黑桃3
GameLogic.HJ_CT_SPECIAL_2 = 11						--对地=对红2
GameLogic.HJ_CT_SPECIAL_1 = 12						--对天=对红Q

-- 温州两张 红黑10/红黑6 的大小比较是与常规牌九/红九不同的。
...
function GameLogic:GetCardType( cbCardData, cbCardCount)
    ...
    if 2 == cbFirstCardValue and 8 == cbSecondCardValue then
