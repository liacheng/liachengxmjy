...
cmd.SUB_S_SEND_USER_BET_INFO    = 111       --发送下注(服务端消息)
cmd.SUB_S_USER_SCORE_NOTIFY     = 112       --发送下注(服务端消息)
...
{			
    ...
    {k = "lBankerCurWinScore",      t = "score"},				                    -- 庄家赢分		
    {k = "wBankerTime",             t = "word"},                                    -- 庄家局数			
    {k = "bEnableSysBanker",        t = "bool"},				                    -- 系统做庄	
    {k = "lApplyBankerCondition",   t = "score"},			                        -- 申请条件		
    {k = "lAreaLimitScore",         t = "score"},				                    -- 区域限制	
    {k = "bPlayerJetton",           t = "bool"},                                    -- 是否参与
    {k = "wFrontWinUser",           t = "word",     l = {5}},                       -- 扑克数目
    {k = "lFrontWinScore",          t = "score",    l = {5}},                       -- 扑克数目	
