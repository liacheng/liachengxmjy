...
{
	{t="byte",k="bWinMen",l={cmd.AREA_COUNT+1} }	--最近AREA_COUNT次转盘结果记录
}
...
cmd.CMD_S_StatusFree=
{
    ...
    {t="dword",k="dwGoldSharkTime"},                    --打中金沙时间
    {t="dword",k="dwSharkTime"},                        --打中银鲨时间

    {t="string",k="szGameRoomName",s=32},				--房间名称 
    {k = "CustomAndroid", t = "table", d = cmd.tagCustomAndroid},  --机器人配置
    {t="bool",k="bEnableBank"},	                        --是否允许银行
}
--下注信息
cmd.tagUserBet=
{
...
cmd.CMD_S_StatusPlay=  --StatusEnd也是用这个结构体
{
    ...
    {t="dword",k="dwGoldSharkTime"},                    --打中金沙时间
    {t="dword",k="dwSharkTime"},                        --打中银鲨时间
    {t="word",k="wFrontWinThreeUser",l={5}},            --游戏结束前三名用户
    {t="score",k="lFrontWinThreeScore",l={5}},           --游戏结束前三名分数
    {t="bool",k="bSystemBaoJi"},                        --系统爆机
    {t="score",k="lBonusGold"},		                    --中彩金
    {k = "CustomAndroid", t = "table", d = cmd.tagCustomAndroid},  --机器人配置
}
...
cmd.CMD_S_GameStart=
{
    ...
    {t = "int",   k= "nListUserCount"},                   --列表人数
	{t = "int",   k= "nAndriodCount"},                    --机器人列表人数
