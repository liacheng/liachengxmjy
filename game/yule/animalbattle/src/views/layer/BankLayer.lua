...
function BankLayer:ctor(parentNode)
    ...
    self.curCoinLabel:setFontName(appdf.FONT_FILE)
    self.insureLabel:setFontName(appdf.FONT_FILE)
...
function BankLayer:refreshBankScore( )
    --携带游戏币
    local str = "当前金币:"..GlobalUserItem.tabAccountInfo.lUserScore
    self.curCoinLabel:setString(str)
    
    --银行存款
    str = "我的存款:"..GlobalUserItem.tabAccountInfo.lUserInsure
