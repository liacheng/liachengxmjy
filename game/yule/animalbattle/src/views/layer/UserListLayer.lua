...
function UserListLayer:ctor()
    ...
    local callBack = function(sender, eventType) self:setVisible(false) end
	local m_pIconBg = csbNode:getChildByName("m_pIconBG")
    self.m_pBtnShadeClose = csbNode:getChildByName("Button_1")
    ...
    self.m_pBtnShadeClose:addClickEventListener(callBack)
