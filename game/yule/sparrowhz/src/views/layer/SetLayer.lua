...
function SetLayer:ctor(scene)
	...
	--声音
	self.btMusicOn:setVisible(GlobalUserItem.nMusic == 100)
	self.btMusicOff:setVisible(GlobalUserItem.nMusic == 0)
	self.btEffectOn:setVisible(GlobalUserItem.nSound == 100)
	self.btEffectOff:setVisible(GlobalUserItem.nSound == 0)
    ExternalFun.setBackgroundAudio("sound/BACK_PLAYING.wav")
	--版本号
