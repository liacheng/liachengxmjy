...
cmd.g_cbAreaOdds =
{
	...
	50,
	60,30,17,12,8,7,6,6,7,8,12,17,30,60,
...
--筹码面值
cmd.g_lScoreType={100,1000,10000,100000,1000000,5000000,10000000};
--筹码光标
cmd.g_nJettonIDI={3000,3001,3002,3003,3004,3005,3006};
--筹码位图
cmd.g_nJettonIDB={3100,3101,3102,3103,3104,3105,3106};
--筹码IDC
cmd.g_nJettonIDC={3200,3201,3202,3203,3204,3205,3206};
