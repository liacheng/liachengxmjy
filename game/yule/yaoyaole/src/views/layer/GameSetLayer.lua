...
function GameSetLayer:ctor(version)
    ...
    -- 背景
    local sprStr = string.format("setting/yyl_set_icon_bg.png")
    ...
    -- 音乐按钮-关
    -- 音乐文字
    sprStr = string.format("setting/yyl_set_btn_open.png")
    ...
    sprStr = string.format("setting/yyl_set_btn_close.png")
	ccui.Button:create(sprStr, sprStr)
        :move(568, 360)
    ...
    sprStr = string.format("setting/yyl_set_icon_music.png")
    ...
    sprStr = string.format("setting/yyl_set_icon_sound.png")
    display.newSprite(sprStr)
		:setTag(GameSetLayer.TAG_BACKGROUND)
		:move(740,360)
		:addTo(self)
    ...
    -- 关闭按钮
    ccui.Button:create("setting/yyl_set_btn_exit.png","setting/yyl_set_btn_exit.png")
        :move(910, 490)
