...
function UserListLayer:ctor()
	...
	--加载csb资源
	local csbNode = ExternalFun.loadCSB("yyl_UserListLayer.csb", self)
    ...
    self.m_pBtnClose:addClickEventListener(function(sender, eventType) self:setVisible(false) end)
