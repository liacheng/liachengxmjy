...
local GameFrame = appdf.req(module_pre .. ".models.yaoyaole_GameFrame")
...
function GameLayer:onSubGameStart( dataBuffer )
    ...
    --播放开始音效
    ExternalFun.playSoundEffect("yaoyaole_game_start.mp3")
    ExternalFun.playSoundEffect("yaoyaole_game_start1.mp3")
    -- --游戏倒计时
...
--        end
        ExternalFun.playSoundEffect("yaoyaole_add_gold.mp3")
...
function GameLayer:onSubGameEnd( dataBuffer )
    ExternalFun.playSoundEffect("yaoyaole_game_stop.mp3")
    ExternalFun.playSoundEffect("yaoyaole_game_stop1.mp3")
    ...
    egr.tagUserWinRank = cmd_table.tagUserWinRank
...
function GameLayer:formatScoreText(score)
    return ExternalFun.formatScoreText(score)
end
---------------------------------------------------------------------------------------
return GameLayer