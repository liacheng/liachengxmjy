...
local cmd =  {}
cmd.RES_PATH                    =   "game/yule/oxfive/res/"

--游戏版本
cmd.VERSION 					= appdf.VersionValue(6,7,0,1)
--游戏标识
cmd.KIND_ID						= 29  --多配置牛牛
...
--发牌完成
cmd.SUB_C_SEND_CARD_FINISH      = 6
--更新库存
cmd.SUB_C_STORAGE				= 7
--设置上限
cmd.SUB_C_STORAGEMAXMUL			= 8
--请求查询用户
cmd.SUB_C_REQUEST_QUERY_USER	= 9
--用户控制
cmd.SUB_C_USER_CONTROL			= 10
...
cmd.CMD_S_StatusCall = 
{
    ...
    { k = "cbCallTimes",t = "byte",l = {cmd.GAME_PLAYER}},                  --叫庄倍数
    { k = "cbDynamicJoin",t = "byte"},                                      --动态加入
    { k = "cbPlayStatus",t = "byte",l = {cmd.GAME_PLAYER}},                 --用户状态
    { k = "cbCurrBankerTimes",t = "byte"},                                  --抢庄倍率
    { k = "bCallStatus",t = "bool",l = {cmd.GAME_PLAYER}},                  --抢庄状态
    --用户扑克
    {k = "cbHandCardData", t = "byte", l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}}, 
...
cmd.CMD_S_StatusScore = 
{
    ...
    { k = "cbDynamicJoin",t = "byte"},                                      --动态加入
    { k = "cbTimeLeave",t = "byte"},                                        --剩余时间
    { k = "lTurnMaxMul",t = "score",l = {cmd.GAME_PLAYER}},               --最大下注
    { k = "lTableScore",t = "score",l = {cmd.GAME_PLAYER}},                 --下注数目
    { k = "wBankerUser",t = "word"},                                        --庄家用户
    { k = "cbCurrBankerTimes",t = "byte"},                                  --抢庄倍率
    { k = "bCallTimes",t = "byte",l = {cmd.GAME_PLAYER}},                   --下分倍率
    --用户扑克
    { k = "cbHandCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
...
cmd.CMD_S_StatusPlay = 
{
    ...
    { k = "wBankerUser",t = "word"},                                        --庄家用户
    { k = "cbCurrBankerTimes",t = "byte"},                                  --抢庄倍率
    { k = "bOpenCardStatus",t = "bool",l = {cmd.GAME_PLAYER}},              --开牌状态
    { k = "bCallTimes",t = "byte",l = {cmd.GAME_PLAYER}},                   --下分倍率
...
--    { k = "cbPlayerStatus",t = "byte",l = {cmd.GAME_PLAYER}},               --玩家状态
    { k = "lTurnMaxMul",t = "score",l = {cmd.GAME_PLAYER}},               --最大下注
    { k = "wBankerUser",t = "word"},                                        --庄家用户
    { k = "bBankerTimes",t = "byte"},                                       --叫庄倍率
    { k = "bCallTimes",t = "byte"},                                         --叫庄倍率
    { k = "wCallUser",t = "word"},                                          --叫家用户
    { k = "bAllNoCatch",t = "bool"},                                        --都不抢庄
}
...
cmd.CMD_S_GameEnd = 
{
    ...
    { k = "cbCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
    { k = "cbDelayOverGame",t = "byte"},                                  --
    { k = "cbCardType",t = "byte",l = {cmd.GAME_PLAYER}},                 --玩家牌型没用
    { k = "cbOxCardType",t = "byte",l = {cmd.GAME_PLAYER}},               --玩家牌型
}

--发牌数据包
cmd.CMD_S_SendCard = 
{
    { k = "eSendType",t = "int"},                                       --首发四张、最后一张
    { k = "wCurrentUser",t = "word"},                                       --当前玩家
    --(发全部5张牌，如果发牌模式是发四等五，则前面四张和CMD_S_GameStart消息一样)叫家用户
    { k = "cbCardData",t = "byte",l = {cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT,cmd.MAX_CARDCOUNT}},
...
{
    { k = "bOX",t = "byte"},                                                --牛牛标识
    { k = "cbOxCardData",t = "byte", l = {cmd.MAX_CARDCOUNT}},              --牛牛扑克
}
