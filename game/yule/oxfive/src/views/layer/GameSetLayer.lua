...
function GameSetLayer:ctor(version)
    ...
    -- 背景
    rootLayer, self._setLayer = ExternalFun.loadRootCSB("game/SetLayer.csb", self)
    self.setBg = self._setLayer:getChildByName("sp_setLayer_bg")
        
    -- 音乐按钮-开
    -- 音乐按钮-关
    -- 音乐文字
	ccui.Button:create("oxfive_set_btn_open.png","oxfive_set_btn_open.png","oxfive_set_btn_open.png",UI_TEX_TYPE_PLIST)
        :move(567, 340)
        :setTag(GameSetLayer.TAG_MUSIC_OPEN)
        :addTo(self)
        :addTouchEventListener(onBtnCallBack)

	ccui.Button:create("oxfive_set_btn_close.png","oxfive_set_btn_close.png","oxfive_set_btn_close.png",UI_TEX_TYPE_PLIST)
        :move(567, 340)
    ...
    -- 关闭按钮
    ccui.Button:create("oxfive_btn_close_1.png","oxfive_btn_close_1.png","oxfive_btn_close_1.png",UI_TEX_TYPE_PLIST)
        :move(935, 490)
