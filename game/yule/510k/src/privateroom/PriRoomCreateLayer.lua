...
--    self.m_txtSelectPlayer:setString("2人")
    ...
    self.m_playlist = {}
    for i=1,2 do
        local checkbox = self.m_spBg:getChildByName("check_rule"..i)
...
--        end
    ...
    if nScoreList > 0 then
        ...
        self.m_txtSelectRule:setString(string.format("%d分", 1))
...
function PriRoomCreateLayer:onSelectedScoreEvent(tag, sender)
    ...
    self.m_nSelectScore = tag - 100--self.m_scoreList[self.m_nSelectScoreIdx - CELL_BEGIN]
