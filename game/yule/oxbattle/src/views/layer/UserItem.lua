...
function UserItem:ctor()
	...
	--抢庄标志
--zy	local rob = csbNode:getChildByName("sp_rob")
...
--    self.m_head = PopupInfoHead:createClipHead(useritem, self.m_headSize,"head_bg.png")
    self.m_head = PopupInfoHead:createNormal(userItem, 78)
	self.m_head:setPosition(-71,54)
