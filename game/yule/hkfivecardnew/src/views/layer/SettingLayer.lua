...
SettingLayer.RES_PATH 				= "game/yule/hkfivecardnew/res/"
...
function SettingLayer:ctor(version)
    ...
    -- 背景
    rootLayer, self._setLayer = ExternalFun.loadRootCSB("game/set.csb", self)

    self.setBg = self._setLayer:getChildByName("bg")
    self.setBg:setLocalZOrder(5)
    self.setBg:setTag(SettingLayer.TAG_BACKGROUND)

    self._setLayer:getChildByName("Sprite_1"):setLocalZOrder(5)
        
    -- 音乐按钮-开
    -- 音乐按钮-关
    -- 音乐文字   
	ccui.Button:create("hkfivecardnew_set_icon_open.png", "hkfivecardnew_set_icon_open.png","hkfivecardnew_set_icon_open.png",UI_TEX_TYPE_PLIST)
        :move(568, 360)
        :setTag(SettingLayer.TAG_MUSIC_OPEN)
        :addTo(self)
        :addTouchEventListener(onBtnCallBack)

	ccui.Button:create("hkfivecardnew_set_icon_close.png", "hkfivecardnew_set_icon_close.png","hkfivecardnew_set_icon_close.png",UI_TEX_TYPE_PLIST)
        :move(568, 360)
        :setTag(SettingLayer.TAG_MUSIC_CLOSE)
        :addTo(self)
        :addTouchEventListener(onBtnCallBack)        

    display.newSprite("#hkfivecardnew_set_icon_music.png")
    ...
    display.newSprite("#hkfivecardnew_set_icon_sound.png")
		:setTag(SettingLayer.TAG_BACKGROUND)
		:move(740,360)
		:addTo(self)

    -- 关闭按钮
    ccui.Button:create("hkfivecardnew_btn_close_1.png","hkfivecardnew_btn_close_1.png","hkfivecardnew_btn_close_1.png",UI_TEX_TYPE_PLIST)
        :move(910, 510)
