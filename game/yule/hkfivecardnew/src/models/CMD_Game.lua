...
cmd.CMD_S_SatatusPlay   =
{
    ...
    {k="cbHandCardData",t="byte",l={cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN}}, --桌面扑克
    --历史积分
    {k="lTurnScore",t="score",l={cmd.GAME_PLAYER}},      --积分信息 
    {k="lCollectScore",t="score",l={cmd.GAME_PLAYER}},   --积分信息
    --机器人信息
...
cmd.CMD_S_GAMEStart =
{
    ...
    {k="cbHandCardData",t="byte",l={cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN,cmd.RECORD_LEN}} --用户扑克
}
