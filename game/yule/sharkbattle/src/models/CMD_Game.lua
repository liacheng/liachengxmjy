...
cmd.MAX_UNITNOTE=5000000
cmd.MIN_UNITNOTE=1000
...
{
  {t="score",k="lStorage"},
  {t="score",k="lStorageDeduct"},
}
--游戏状态
cmd.CMD_S_StatusFree=
{
	{t="byte",k="cbTimeLeave"},						--剩余时间	
	{t="score",k="lPlayScore"},							--lxy玩家分数
...
cmd.SUB_S_AMDIN_COMMAND  = 109						--管理员命令
cmd.SUB_S_UPDATE_STORAGE =110                       --更新库存

cmd.SUB_S_ADMIN_STORAGE_INFO  = 111				--库存命令
cmd.SUB_S_SEND_USER_BET_INFO  = 112                    --发送下注
cmd.SUB_S_SWITCT_NUM = 199							--切换数量

cmd.MAX_SITCH_NUM = 6                  --下注数量
--切换数量
cmd.CMD_S_SwitchNum=
{
    {t="int",k="lAddScore",l={cmd.MAX_SITCH_NUM}},
}
...
cmd.CMD_S_PlayBet =
{
    ...
    {t="string",k="szPlayerName",s=32},					--房间名称 
    {t="score",k="mHBet"},							--筹码数量
...
----------------------------------------------------------------------------------
--客户端命令结构
cmd.SUB_C_PLAY_BET =108									--下注消息
cmd.SUB_C_BET_CLEAR =109									--清除下注
--cmd.SUB_C_EXCHANGE_CHIP = 110						--兑换筹码
--cmd.SUB_C_AMDIN_COMMAND =4							--管理员命令
--cmd.SUB_C_UPDATE_STORAGE =5						--库存信息
